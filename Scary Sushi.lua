...
local Test = Window:NewTab("Get Items")
local TestSection = Test:NewSection("Get Items")
...
Section:NewButton("Goto Elevator", "Teleports to Elevator", function()
    game.Players.LocalPlayer.character.HumanoidRootPart.CFrame = CFrame.new(-281.114105, 4.62178946, 66.7724991, 0.0177888703, -1.05430438e-07, 0.99984175, 3.96934+858e-08, 1, 1.04740906e-07, -0.99984175, 3.78239804e-08, 0.0177888703)
end)
...
local Tab = Window:NewTab("Workstations")
local Section = Tab:NewSection("Set workstation")
...
Section:NewButton("Set workstation 1", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation5
        p1.CFrame = p2.CFrame
    end)
...
Section:NewButton("Set workstation 2", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation1
        p1.CFrame = p2.CFrame
    end)

    TestSection:NewButton("Goto Place Of Delivery", "N/A", function()
    ...
    TestSection:NewButton("Get Rice", "N/A", function()
        ...
        TestSection:NewButton("Get Nori", "N/A", function()
        ...
        TestSection:NewButton("Get Tuna", "N/A", function()
        ...
        TestSection:NewButton("Get Flounder", "N/A", function()
        ...
        TestSection:NewButton("Get Eel", "N/A", function()
        ...
        TestSection:NewButton("Get Salmon", "N/A", function()
        ...
        TestSection:NewButton("Room 1", "N/A", function()
            
            local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
            local p2 =  game.Workspace.Garden.Rooms.Room1.SlidingDoor
            p1.CFrame = p2.CFrame
        ...
        TestSection:NewButton("Room 2", "N/A", function()
            
            local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
            local p2 = game.Workspace.Garden.Rooms.Room2.SlidingDoor 
            p1.CFrame = p2.CFrame
            
        end)
    
        TestSection:NewButton("Room 3", "N/A", function()
            
            local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
            local p2 =  game.Workspace.Garden.Rooms.Room3.SlidingDoor
            p1.CFrame = p2.CFrame
           
        end)
    
        TestSection:NewButton("Room 4", "N/A", function()
            
            local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
            local p2 =  game.Workspace.Garden.Rooms.Room4.SlidingDoor
            p1.CFrame = p2.CFrame
        end)
        ...
        Section:NewButton("Finish parkour", "Teleports to Special Recipe", function()
            local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
            local p2 =  game.Workspace.SecondFloor.PortalRoom.Portal
            p1.CFrame = p2.CFrame
        end)
end)

Section:NewButton("Set workstation 3", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation2
        p1.CFrame = p2.CFrame
    end)
...
Section:NewButton("Set workstation 4", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation6
        p1.CFrame = p2.CFrame
    end)
...
Section:NewButton("Set workstation 5", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation7
        p1.CFrame = p2.CFrame
    end)
...
Section:NewButton("Set workstation 6", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation3
        p1.CFrame = p2.CFrame
    end)
...
Section:NewButton("Set workstation 7", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation4
        p1.CFrame = p2.CFrame
    end)
...
Section:NewButton("Set workstation 8", "Teleports your Workstation", function()
    TestSection:NewButton("Goto Workstation", "Teleports Your Workstation", function()
        local p1 = game.Players.LocalPlayer.Character.HumanoidRootPart
        local p2 = game.Workspace.Kitchen.WorkstationSpawns.Workstation8
        p1.CFrame = p2.CFrame
    end)
